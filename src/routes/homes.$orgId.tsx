...
export const Route = createFileRoute('/homes/$orgId')({
  component: FamilyHomeLayout,
})

function FamilyHomeLayout() {
  ...
  const apps = [
    { id: 'dashboard', icon: LayoutGrid, label: t('org.context_global'), color: 'bg-blue-600', path: `/homes/${orgId}`, badge: 0 },
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      {/* Persistent Content Area for sub-apps */}
