  ...
  return (
    <div className="space-y-10 animate-reveal pb-20">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {/* Create Card */}
        <Link to="/dashboard/settings/organization" className="block outline-none">
          <Card 
            className="h-full border-2 border-dashed border-primary/20 bg-primary/5 hover:border-primary/50 hover:bg-primary/10 transition-all duration-300 cursor-pointer group relative overflow-hidden"
          >
        ...
        {orgs.map((org: any) => (
          ...
          >
            <Card 
              className="group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden border-none shadow-sm ring-1 ring-border relative"
            >
              ...
              <CardFooter className="px-4 pb-4 pt-2">
                <div className="w-full">
                  ...
                  >
                    {t('common.dashboard.enter')} <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                  <Button 
                    variant="secondary"
